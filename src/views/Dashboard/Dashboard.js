...
for (var i = 0; i <= elements; i++) {
  data1.push(random(10, 100));
  data2.push(random(30, 50));
  data3.push(45);
}
              ...
              <CardBody className="pb-0">
                <ButtonGroup className="float-right">
                  <Dropdown id='card3' isOpen={this.state.card3}
                    ...
                    <DropdownToggle caret className="p-0" color="transparent">
                      <i className="icon-sProject 3ettings"></i>
                    </DropdownToggle>
                    <DropdownMenu right>
                      <DropdownItem>Action</DropdownItem>
                      <DropdownItem>Another action</DropdownItem>
              ...
              <CardBody>
                  ...
                  <Col xs="12" xl="4">
                    ...
                    <ul className="icons-list">
                      <li>
                        ...
                        <div className="desc">
                          <div className="title">Module-Project name</div>
                      ...
                      <li>
                        <i className="icon-screen-desktop bg-info"></i>
                        <div className="desc">
                          <div className="title">Module-Project name</div>
                          <small>Description</small>
                        </div>
                      ...
                      <li>
                        <i className="icon-screen-desktop bg-warning"></i>
                        <div className="desc">
                          <div className="title">Module-Project name</div>
                          <small>Description</small>
                        </div>
                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <i className="flag-icon flag-icon-in h4 mb-0" title="br" id="br"></i>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <i className="flag-icon flag-icon-in h4 mb-0" title="fr" id="fr"></i>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <i className="flag-icon flag-icon-in h4 mb-0" title="es" id="es"></i>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <i className="flag-icon flag-icon-in h4 mb-0" title="pl" id="pl"></i>
                    </td>
                    <td>
                      <div className="clearfix">
                        <div className="float-left">
